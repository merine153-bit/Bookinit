    ...
    if (error) {
      setError(
        error.message.includes("Invalid login")
          ...
          : "حدث خطأ أثناء تسجيل الدخول. حاول مجددًا."
      );
      return;
    }
    navigate("/dashboard");
    ...
    <div className="flex min-h-screen items-center justify-center bg-surface px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          <h1 className="mb-1 text-2xl font-extrabold text-brand-950">تسجيل الدخول</h1>
          <p className="mb-6 text-sm text-brand-500">
            تابع رحلتك نحو إتقان الفرنسية الكيبيكية والنجاح في TCF Canada.
          </p>
          ...
          <p className="mt-6 text-center text-sm text-brand-600">
            ليس لديك حساب؟{" "}
            <Link to="/signup" className="font-bold text-accent-600">
              أنشئ حسابًا جديدًا
            </Link>
          </p>
        </div>
